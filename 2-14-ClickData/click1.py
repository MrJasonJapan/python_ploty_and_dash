...
app.layout = html.Div([
    ...
    html.Div([
        # Image component is used to display the image corresponding to the clicked data point.
        html.Img(id='click-image', src='', height=300)
    ], style={'paddingTop': 35})
])
...
def callback_image(clickData):
    # grab x and y values from the clickData object and assign them to wheel and color respectively.
